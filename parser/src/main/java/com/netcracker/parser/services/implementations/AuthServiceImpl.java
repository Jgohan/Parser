...
import com.netcracker.parser.exceptions.UserWithThisUsernameAlreadyExistsException;
...
public class AuthServiceImpl implements AuthService {
    ...
    public void saveUser(User user) {
        if (userRepository.existsByUsername(user.getUsername())) throw new UserWithThisUsernameAlreadyExistsException();
